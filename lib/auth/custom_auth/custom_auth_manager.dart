...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    lifelinesMapAuthUserSubject.add(
      LifelinesMapAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<LifelinesMapAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  LifelinesMapAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = LifelinesMapAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    lifelinesMapAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
LifelinesMapAuthUser? currentUser;
